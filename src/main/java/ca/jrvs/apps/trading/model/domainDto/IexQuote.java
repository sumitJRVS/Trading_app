...
public class IexQuote {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("avgTotalVolume", avgTotalVolume).append("calculationPrice", calculationPrice).append("change", change).append("changePercent", changePercent).append("close", close).append("closeTime", closeTime).append("companyName", companyName).append("delayedPrice", delayedPrice).append("delayedPriceTime", delayedPriceTime).append("extendedChange", extendedChange).append("extendedChangePercent", extendedChangePercent).append("extendedPrice", extendedPrice).append("extendedPriceTime", extendedPriceTime).append("high", high).append("iexAskPrice", iexAskPrice).append("iexAskSize", iexAskSize).append("iexBidPrice", iexBidPrice).append("iexBidSize", iexBidSize).append("iexLastUpdated", iexLastUpdated).append("iexMarketPercent", iexMarketPercent).append("iexRealtimePrice", iexRealtimePrice).append("iexRealtimeSize", iexRealtimeSize).append("iexVolume", iexVolume).append("latestPrice", latestPrice).append("latestSource", latestSource).append("latestTime", latestTime).append("latestUpdate", latestUpdate).append("latestVolume", latestVolume).append("low", low).append("marketCap", marketCap).append("open", open).append("openTime", openTime).append("peRatio", peRatio).append("previousClose", previousClose).append("primaryExchange", primaryExchange).append("sector", sector).append("symbol", symbol).append("week52High", week52High).append("week52Low", week52Low).append("ytdChange", ytdChange).toString();
    }
